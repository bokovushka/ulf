...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_meta_width_function_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/meta-width-function.js */ \"./src/js/modules/meta-width-function.js\");\n/* harmony import */ var _modules_animate_scroll_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/animate-scroll.js */ \"./src/js/modules/animate-scroll.js\");\n/* harmony import */ var _modules_menu_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/menu.js */ \"./src/js/modules/menu.js\");\n/* harmony import */ var _modules_menu_scroll_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/menu-scroll.js */ \"./src/js/modules/menu-scroll.js\");\n/* harmony import */ var _modules_toolbar_scroll_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/toolbar-scroll.js */ \"./src/js/modules/toolbar-scroll.js\");\n/* harmony import */ var _modules_toolbar_test_drive_request_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/toolbar-test-drive-request.js */ \"./src/js/modules/toolbar-test-drive-request.js\");\n/* harmony import */ var _modules_height_max_height_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/height-max-height.js */ \"./src/js/modules/height-max-height.js\");\n/* harmony import */ var _modules_pagination_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/pagination.js */ \"./src/js/modules/pagination.js\");\n/* harmony import */ var _modules_filter_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/filter.js */ \"./src/js/modules/filter.js\");\n/* harmony import */ var _modules_tinder_cards_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/tinder-cards.js */ \"./src/js/modules/tinder-cards.js\");\n/* harmony import */ var _modules_js_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/js.js */ \"./src/js/modules/js.js\");\n\n\n\n\n\n\n\n\n\n\n\n\n\n//# sourceURL=webpack://tas/./src/js/main.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n\n\n//? height = max height\n// Оголошення функції setEqualHeight\nfunction setEqualHeight(columns) {\n\tvar tallestcolumn = 0;\n\tcolumns.each(function () {\n\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(this).css('height', 'auto'); // Спочатку встановлюємо автоматичну висоту\n\t\tvar currentHeight = jquery__WEBPACK_IMPORTED_MODULE_0__(this).height();\n\t\tif (currentHeight > tallestcolumn) {\n\t\t\ttallestcolumn = currentHeight;\n\t\t}\n\t});\n\tcolumns.height(tallestcolumn);\n}\n\nwindow.addEventListener('resize', (e) => {\n\tcardResize();\n});\n\nwindow.addEventListener('load', function () {\n\tsetTimeout(() => {\n\t\tcardResize();\n\t}, 500);\n}, false);\n\nfunction cardResize() {\n\n}\n\njquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(function () {\n\tsetEqualHeight(jquery__WEBPACK_IMPORTED_MODULE_0__(\".our-fleet-preview .our-fleet-preview--item .name\"));\n\tsetEqualHeight(jquery__WEBPACK_IMPORTED_MODULE_0__(\".car-content .subscription-period-tab .tab-content .tab-pane .name\"));\n});\n\n//# sourceURL=webpack://tas/./src/js/modules/height-max-height.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n\n\nlet lastScrollTop = 0;\n\njquery__WEBPACK_IMPORTED_MODULE_0__(window).scroll(function (event) {\n\tlet st = jquery__WEBPACK_IMPORTED_MODULE_0__(this).scrollTop();\n\tlet headerThreshold = 15;\n\tlet mainThreshold = 15;\n\n\n\tif (jquery__WEBPACK_IMPORTED_MODULE_0__(window).width() <= 1023) {\n\t\t// Perform header modifications only if window width is 768 or greater\n\t\tif (st > lastScrollTop && jquery__WEBPACK_IMPORTED_MODULE_0__(window).scrollTop() >= mainThreshold) {\n\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".header-main\").addClass(\"header--show\");\n\t\t} else {\n\t\t\tif (jquery__WEBPACK_IMPORTED_MODULE_0__(window).scrollTop() <= headerThreshold) {\n\t\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".header-main\").removeClass(\"header--show\");\n\t\t\t}\n\t\t}\n\t}\n\tlastScrollTop = st;\n});\n\n\n\n\n\n\n\n//# sourceURL=webpack://tas/./src/js/modules/menu-scroll.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n\n\nlet lastScrollTop = 15;\nlet ticking = false;\n\njquery__WEBPACK_IMPORTED_MODULE_0__(window).scroll(function () {\n\tif (!ticking) {\n\t\twindow.requestAnimationFrame(function () {\n\t\t\tlet st = jquery__WEBPACK_IMPORTED_MODULE_0__(window).scrollTop();\n\t\t\tlet footerOffset = jquery__WEBPACK_IMPORTED_MODULE_0__('.footer').offset().top;\n\t\t\tlet windowHeight = jquery__WEBPACK_IMPORTED_MODULE_0__(window).height();\n\n\t\t\tif (jquery__WEBPACK_IMPORTED_MODULE_0__(window).width() < 768) {\n\t\t\t\tif (st > lastScrollTop) {\n\t\t\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".toolbar-fixed\").removeClass(\"--show\").addClass(\"--hide\");\n\t\t\t\t} else if (st <= 0) {\n\t\t\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".toolbar-fixed\").removeClass(\"--hide\").addClass(\"--show\");\n\t\t\t\t} else {\n\t\t\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".toolbar-fixed\").removeClass(\"--hide\").addClass(\"--show\");\n\t\t\t\t}\n\n\t\t\t\t// Check if the footer is in view\n\t\t\t\tif (st + windowHeight >= footerOffset) {\n\t\t\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".toolbar-fixed\").removeClass(\"--show\").addClass(\"--hide\");\n\t\t\t\t}\n\t\t\t}\n\n\t\t\tlastScrollTop = Math.max(st, 0);\n\t\t\tticking = false;\n\t\t});\n\t\tticking = true;\n\t}\n});\n\n\n//# sourceURL=webpack://tas/./src/js/modules/toolbar-scroll.js?");

/***/ }),

/***/ "./src/js/modules/toolbar-test-drive-request.js":
/*!******************************************************!*\
  !*** ./src/js/modules/toolbar-test-drive-request.js ***!
  \******************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n\n\nlet lastScrollTop = 15;\nlet ticking = false;\n\njquery__WEBPACK_IMPORTED_MODULE_0__(window).scroll(function () {\n\tif (!ticking) {\n\t\twindow.requestAnimationFrame(function () {\n\t\t\tlet st = jquery__WEBPACK_IMPORTED_MODULE_0__(window).scrollTop();\n\t\t\tlet footerOffset = jquery__WEBPACK_IMPORTED_MODULE_0__('.footer').offset().top;\n\t\t\tlet windowHeight = jquery__WEBPACK_IMPORTED_MODULE_0__(window).height();\n\n\t\t\tif (jquery__WEBPACK_IMPORTED_MODULE_0__(window).width() < 768) {\n\t\t\t\tif (st > lastScrollTop) {\n\t\t\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".toolbar-test-drive-request\").removeClass(\"--show\").addClass(\"--hide\");\n\t\t\t\t} else if (st <= 0) {\n\t\t\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".toolbar-test-drive-request\").removeClass(\"--hide\").addClass(\"--show\");\n\t\t\t\t} else {\n\t\t\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".toolbar-test-drive-request\").removeClass(\"--hide\").addClass(\"--show\");\n\t\t\t\t}\n\n\t\t\t\t// Check if the footer is in view\n\t\t\t\tif (st + windowHeight >= footerOffset) {\n\t\t\t\t\tjquery__WEBPACK_IMPORTED_MODULE_0__(\".toolbar-test-drive-request\").removeClass(\"--show\").addClass(\"--hide\");\n\t\t\t\t}\n\t\t\t}\n\n\t\t\tlastScrollTop = Math.max(st, 0);\n\t\t\tticking = false;\n\t\t});\n\t\tticking = true;\n\t}\n});\n\n\n//# sourceURL=webpack://tas/./src/js/modules/toolbar-test-drive-request.js?");
